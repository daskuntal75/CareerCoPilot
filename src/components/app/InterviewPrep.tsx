    ...
    <div className="max-w-5xl mx-auto">
      ...
      {activeTab === "questions" && (
        <div className="space-y-6">
          ...
          {/* Questions and sidebar in 2-col layout */}
          ...
          {/* Questions to Ask — full width below the questions grid */}
          ...
          {/* AI Disclaimer */}
          <div className="mt-6 text-xs text-muted-foreground bg-muted/30 border border-border rounded-lg p-3 flex items-start gap-2">
            <Info className="w-3.5 h-3.5 mt-0.5 flex-shrink-0" />
            <span>These results are generated by AI and are non-deterministic — each run may produce different results. Always review and verify before use.</span>
          </div>
        </div>
      )}
